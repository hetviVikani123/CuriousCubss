    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<a href='javascript:void(0);' class='material-link' data-type='" . pathinfo($pdfPath, PATHINFO_EXTENSION) . "' data-path='" . $pdfPath . "'>
                <div class='card'>
                    ...
                    <div class='circle'>
                        <img src='<?php echo $imgPath; ?>' alt=' $materialName'>
    ...
    materialLinks.forEach(function(link) {
        link.addEventListener('click', function() {
            ...
            if (type === 'pdf') {
                ...
                contentContainer.innerHTML = '<video controls style="width:800px;"><source src="' + path + '" type="video/mp4"></video>';
            } else {
